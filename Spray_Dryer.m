...
Tp0=303;                    % Initial Particle Temperature [K]
Tg0=403;                    % Initial Gas Temperature [K]
P=1;                        % Pressure [atm]
...
% Process stream
Qmilk=1750/3600;             % Milk Flow Rate [kg/h -> kg/s]
...
Wout=0.005;                  % Inlet Moisture [kg/kg]
dp=2*1e-4;                   % Particle Diameter [m]
vp0=0.3;                     % Initial particle velocity [m/s]
...
% Gas stream
Gdry=20;                    % Dry Gas Flow Rate [kg/s]
D=5.5;                      % Dryre Diameter [m]
